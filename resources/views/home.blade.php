                        ...
                        <div class="js-slide bg-img-hero-center" data-animation-delay="0">
                            <div class="row min-height-420 py-7 py-md-0">
                                ...
                                <div class="col-xl-5 col-6  d-flex align-items-center" data-scs-animation-in="fadeInUp"
                                    data-scs-animation-delay="500">
                                    <img class="img-fluid" src="/assets/img/416X420/img2.png"
                                        alt="Image Description">
                                </div>
                            </div>
                        </div>
                        <div class="js-slide bg-img-hero-center" data-animation-delay="0">
                            <div class="row min-height-420 py-7 py-md-0">
                                ...
                                <div class="col-xl-5 col-6  d-flex align-items-center"
                                    ...
                                    <img class="img-fluid" src="/assets/img/416X420/img3.png"
                                        alt="Image Description">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-auto mb-6 mb-md-0">
                        <div class="p-3 border border-width-2 border-primary borders-radius-20 bg-white min-width-370">
                            ...
                            <h5 class="mb-2 font-size-14 text-center mx-auto max-width-180 text-lh-18"><a
                                    ...
                                    class="text-blue font-weight-bold">Game Console Controller + USB 3.0 Cable</a></h5>
                                    ...
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        ...
                                        <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                            <div class="mb-4">
                                                ...
                                                <h5 class="product-item__title"><a
                                                        href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                        class="text-blue font-weight-bold">Smartwatch 2.0 LTE Wifi</a>
                                                </h5>
                                            </div>
                                            <div class="flex-center-between mb-3">
                                                <div class="prodcut-price">
