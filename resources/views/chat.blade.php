    ...
    <main id="content" role="main" class="container-fluid mt-5 mb-5">
        <div class="card text-center chatCard">
            ...
            <div class="card-body" style="min-height:350px;">
                <span class="clearfix">
                    <span class="badge text-white float-left fs-1 a_chat bg-info mb-1 mt-1">Hello1</span>
                </span>
                <span class="clearfix"> 
                    <span class="badge text-white float-right a_chat bg-warning mb-1 mt-1">Hello1</span>
                </span>
